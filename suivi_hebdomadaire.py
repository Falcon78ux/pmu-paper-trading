...
# Meme table de reference que /confiance (commandes_telegram.py) - dupliquee
# ici volontairement pour eviter toute dependance croisee entre scripts.
REFERENCE_BACKTEST = {
...
def main():
    ...
    # N'enregistre que le lundi (ou premier run apres le lundi si le
    # systeme etait indisponible), pour avoir un rythme regulier
