...
MODELES = [
    ...
    "v15", "v18",
    "v110", "v110dutch", "v110favori", "v110d4", "v110sniper", "v110place", "v110antifav",
...
MODELES_AVEC_CLV = [
    "v14", "v14dutch", "v14favori", "v14sire",
    "v15", "v18",
    "v110", "v110dutch", "v110favori", "v110d4", "v110sniper", "v110antifav",
    "consensus_place",
    "2favori",
]
...
def cle_log_modele(cle):
    ...
    d'affichage."""
    if cle in ("v14dutch", "v14favori", "v14sire", "v110dutch", "v110favori", "v110d4", "v110sniper", "v110place", "v110antifav", "consensus_place", "couple_harville"):
        return cle
...
def traiter_calibration():
    ...
    MODELES_CALIBRABLES = ["v14", "v15", "v18", "v110", "v110sniper"]
